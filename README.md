...
- `희망하는 면접 산업군, 직무, 직업 선택`
    - 데이터베이스에 미리 저장해놓은 산업군, 직무, 직업을 선택하여 사용자가 자신이 희망하는 직업의 면접 질문을 받아볼 수 있습니다.
    - 산업군, 직무, 직업 순으로 선택이 가능하며, 선택을 하지 않을 시 '다음'버튼이 활성화 되지 않습니다.
    - 모든 선택이 완료 되었을 시, '다음' 버튼을 클릭하여 AI모의면접을 시작합니다.
